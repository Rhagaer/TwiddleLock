...
bubble:
        stmfd	sp!, {r4, r5, r6, r7, r8, r9, lr}	@ save variables to stack
...
LoopStart:
	...
	ldr	r9, [r4]			@ temp value stored in r9
	str 	r8, [r4]			@ put value into last pos 
	str	r9, [r4, #element_size]		@ store temp value into next pos
NoSwap:
...
EndFunc:
        ldmfd   sp!, {r4, r5, r6, r7, r8, r9, pc}	@ restore state from stack and leave function
